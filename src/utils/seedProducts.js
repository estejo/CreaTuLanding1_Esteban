...
const products = [
    { id: '1', title: 'El diario de Pilar', price: 24500, category: 'Infantil', description: 'A Pilar le encanta explorar el mundo, pero esta vez el viaje tiene un sabor especial: ¡una carta le revela que tiene una abuela en México! ', stock: 10, image: 'eldiariodepilar.JPG' },
    { id: '2', title: 'Dinosaurios contra alienigenas', price: 29800, category: 'Infantil', description: 'Hace millones de años, nuestro planeta estaba dominado por criaturas enormes, majestuosas, ¡extraordinarias! LOS DINOSAURIOS.', stock: 10, image: 'dinosaurios.JPG' },
    { id: '3', title: 'Caro dice', price: 20900, category: 'Juvenil', description: 'Una historia de amor online, para leer, chatear y enamorarse.', stock: 10, image: 'carodice.jpg' },
    { id: '4', title: 'RAINBOW BRIDGE PLUS 4', price: 27400, category: 'Escolar', description: 'Children will love exploring the lively, magical world of Bridge Town with their new friends Poppy, Rowan and Fern.', stock: 10, image: 'rainbowbridge.JPG' },
